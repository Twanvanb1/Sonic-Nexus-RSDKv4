...
namespace SNexusObjectDefinitions.SSZ
{
	class SwingPlat : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			sprites[0] = new Sprite(sheet.GetSection(148, 1, 16, 16), -8, -8);
			sprites[1] = new Sprite(sheet.GetSection(165, 1, 16, 16), -8, -8);
			sprites[2] = new Sprite(sheet.GetSection(182, 1, 48, 16), -24, -8);
